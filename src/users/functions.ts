...
export const tanamOnAuthAccountCreate: functions.CloudFunction<UserRecord> = functions.auth.user().onCreate(firebaseUser => {
    const userProfile = users.createUserFromFirebaseAuth(firebaseUser);
    return Promise.all([
