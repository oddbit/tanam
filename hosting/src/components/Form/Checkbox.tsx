...
export function Checkbox({style = "checkmark", label = "Checkbox Text", defaultChecked = false}: CheckboxProps) {
    ...
    <div>
      <label className="flex cursor-pointer select-none items-center">
        <div className="relative">
          ...
          />
          <div className={`mr-4 flex h-5 w-5 items-center justify-center rounded ${isChecked && "border-primary"}`}>
            {getCheckboxStyle()}
          </div>
        </div>
        {label}
