          ...
          <div className="relative z-20 h-35 md:h-65">
            ...
            <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
              ...
              >
                ...
                <span>
                  <Image width={18} height={18} alt="Icon Camera" src={"/icons/sidebar/icon-camera.svg"} />
                </span>
                <span>Edit</span>
              </label>
            </div>
              ...
              <div className="mt-6.5">
                ...
                <div className="flex items-center justify-center gap-3.5">
                  <Link href="#" className="hover:text-primary" aria-label="social-icon">
                    <Image width={18} height={18} alt="Facebook Icon" src={"/icons/sidebar/facebook-icon.svg"} />
                  </Link>
                  <Link href="#" className="hover:text-primary" aria-label="social-icon">
                    <svg
